...
public:
    ...
    using ChildProcessModifier = std::function<void()>;

    void setChildProcessModifier(ChildProcessModifier modifier);
    ChildProcessModifier childProcessModifier() const;
#else
    using QProcess::setChildProcessModifier;
    using QProcess::childProcessModifier;
#endif
...
#if QT_VERSION < QT_VERSION_CHECK(5, 15, 0)
    KProcess::ChildProcessModifier childProcessModifier;
#endif
