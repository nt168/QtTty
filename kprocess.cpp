...
void KProcess::setChildProcessModifier(ChildProcessModifier modifier)
{
    Q_D(KProcess);

    d->childProcessModifier = std::move(modifier);
}

KProcess::ChildProcessModifier KProcess::childProcessModifier() const
{
    Q_D(const KProcess);
...
void KProcess::setupChildProcess()
{
    ...
    if (d->childProcessModifier) {
        d->childProcessModifier();
    }
}
#endif
